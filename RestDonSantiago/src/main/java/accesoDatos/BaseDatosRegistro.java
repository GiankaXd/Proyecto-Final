...
public class BaseDatosRegistro {
    ...
    public ArrayList<Mozos> mozo;
    public ArrayList<Mesas> mesa;
    public ArrayList<Platos> plato;
    public ArrayList<Bebidas> bebida;
    ...
    public String registrarMesa(Mesas Me){
        for (Mesas me : mesa) {
            if (me.getNumero().equals(Me.getNumero())) {
                return "ERROR: El número de mesa ya esta registrada. " + Me.getNumero();
            }
        }
        mesa.add(Me);
